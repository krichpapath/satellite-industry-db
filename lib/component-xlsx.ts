...
export async function createAllComponentsXlsx(db: Database) {
  ...
  for (const product of products) {
    ...
    worksheet.addRow({
      ...
      province: safeText(firm ? provinceLabel(firm.province) : ""),
      ...
      description: safeText(richTextToPlainText(product.description))
    });
  }
